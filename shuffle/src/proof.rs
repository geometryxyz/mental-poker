...
use crate::{multi_exponent_argument, product_argument};
use crate::{
    transcript::TranscriptProtocol,
    utils::{DotProduct, DotProductCalculator, HomomorphicCommitment, PedersenCommitment},
};
    ...
    C: ProjectiveCurve,
{
    pub fn verify(
        ...
        let single_neg_z_commit =
            PedersenCommitment::<C>::commit_vector(proof_parameters.commit_key, &z_vec, zero);
