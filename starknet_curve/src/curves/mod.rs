...
/// G_GENERATOR_X = -1
pub const G_GENERATOR_X: Fq = field_new!(Fq, "874739451078007766457464989774322083649278607533249481151382481072868806602");

/// G_GENERATOR_Y = 2
pub const G_GENERATOR_Y: Fq = field_new!(Fq, "152666792071518830868575557812948353041420400780739481342941381225525861407");